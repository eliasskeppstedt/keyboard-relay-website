      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            href="https://github.com/eliasskeppstedt/keyboard-relay-app/releases/download/v0.0.1/keyboard-relay.zip"
            target="_blank"
            rel="noopener noreferrer"
            title="Download now"
            download
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-0.5">
                <span className="font-mono text-[0.85rem] text-text">Windows Release v0.0.1</span>
        ...
        <div className="flex flex-col gap-3">
          <a
            ...
            href="https://github.com/eliasskeppstedt/keyboard-relay-app/releases/tag/v0.0.1"
            target="_blank"
            rel="noopener noreferrer"
